...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-9$4n#r-x%e^q9+sr44#ds3ov1q&f(r&1mqtw$2$ll3+kg302ih')
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@boardgame.by')
